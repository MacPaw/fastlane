...
module Spaceship
  class ConnectAPI
    class InAppPurchase
      ...
      def get_price_points(client: nil, filter: {}, includes: Spaceship::ConnectAPI::InAppPurchasePricePoint::ESSENTIAL_INCLUDES, fields: nil, limit: nil)
        client ||= Spaceship::ConnectAPI
        resps = client.get_in_app_purchase_price_points(purchase_id: id, filter: filter, includes: includes, fields: fields, limit: limit).all_pages
