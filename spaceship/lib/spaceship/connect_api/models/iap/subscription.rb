...
module Spaceship
  class ConnectAPI
    class Subscription
      ...
      def get_price_points(client: nil, filter: {}, includes: Spaceship::ConnectAPI::SubscriptionPricePoint::ESSENTIAL_INCLUDES, limit: nil, fields: nil)
        client ||= Spaceship::ConnectAPI
        resps = client.get_subscription_price_points(purchase_id: id, filter: filter, includes: includes, limit: limit, fields: fields).all_pages
